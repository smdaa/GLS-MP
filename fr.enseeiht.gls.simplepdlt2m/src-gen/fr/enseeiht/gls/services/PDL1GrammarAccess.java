 ...
 */
package fr.enseeiht.gls.services;
...
public class PDL1GrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ProcessElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.enseeiht.gls.PDL1.Process");
	...
	public class ProcessElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.enseeiht.gls.PDL1.ProcessElement");
		...
		private final RuleCall cRessource_UsageParserRuleCall_4 = (RuleCall)cAlternatives.eContents().get(4);
	...
	public class GuidanceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.enseeiht.gls.PDL1.Guidance");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class WorkSequenceTypeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "fr.enseeiht.gls.PDL1.WorkSequenceType");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("fr.enseeiht.gls.PDL1".equals(grammar.getName())) {
				return grammar;
			}
