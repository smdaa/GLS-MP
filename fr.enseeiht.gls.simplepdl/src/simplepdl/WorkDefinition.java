 ...
 *   <li>{@link simplepdl.WorkDefinition#getNecessary_ressources <em>Necessary ressources</em>}</li>
 * </ul>
 *
...
public interface WorkDefinition extends ProcessElement {
	...
	/**
	 * Returns the value of the '<em><b>Necessary ressources</b></em>' containment reference list.
	 * The list contents are of type {@link simplepdl.Ressource_Usage}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Necessary ressources</em>' containment reference list.
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_Necessary_ressources()
	 * @model containment="true"
	 * @generated
	 */
	EList<Ressource_Usage> getNecessary_ressources();
