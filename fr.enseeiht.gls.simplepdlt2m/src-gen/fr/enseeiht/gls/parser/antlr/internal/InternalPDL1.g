...
@after {
	...
	(
		...
		{
			$current = $this_Ressource_Usage_4.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleRessource_Usage returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRessource_UsageRule()); }
	iv_ruleRessource_Usage=ruleRessource_Usage
	{ $current=$iv_ruleRessource_Usage.current; }
	EOF;

// Rule Ressource_Usage
ruleRessource_Usage returns [EObject current=null]
@init {
	enterRule();
}
@after {
