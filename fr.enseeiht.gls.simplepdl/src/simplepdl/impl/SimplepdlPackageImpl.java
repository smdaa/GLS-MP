...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	public EReference getWorkDefinition_Necessary_ressources() {
	 ...
	 * @generated
	 */
	public EReference getRessource_Usage_Used_ressource() {
		return (EReference)ressource_UsageEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getRessource_Usage_User_WD() {
	...
	public EAttribute getRessource_Usage_Quantite() {
		return (EAttribute)ressource_UsageEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(workDefinitionEClass, WORK_DEFINITION__NECESSARY_RESSOURCES);
		...
		createEReference(ressource_UsageEClass, RESSOURCE_USAGE__USED_RESSOURCE);
		createEReference(ressource_UsageEClass, RESSOURCE_USAGE__USER_WD);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkDefinition_Necessary_ressources(), this.getRessource(), null, "necessary_ressources", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRessource_Usage_Used_ressource(), this.getRessource(), null, "used_ressource", null, 1, 1, Ressource_Usage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRessource_Usage_User_WD(), this.getWorkDefinition(), null, "user_WD", null, 1, 1, Ressource_Usage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRessource_Usage_Quantite(), ecorePackage.getEInt(), "quantite", null, 1, -1, Ressource_Usage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
