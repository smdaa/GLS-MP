...
public class SimplepdlItemProviderAdapterFactory extends SimplepdlAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link simplepdl.Ressource_Usage} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected Ressource_UsageItemProvider ressource_UsageItemProvider;

	/**
	 * This creates an adapter for a {@link simplepdl.Ressource_Usage}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createRessource_UsageAdapter() {
		if (ressource_UsageItemProvider == null) {
			ressource_UsageItemProvider = new Ressource_UsageItemProvider(this);
		}

		return ressource_UsageItemProvider;
	}
	...
	public void dispose() {
		...
		if (ressource_UsageItemProvider != null) ressource_UsageItemProvider.dispose();
	}
