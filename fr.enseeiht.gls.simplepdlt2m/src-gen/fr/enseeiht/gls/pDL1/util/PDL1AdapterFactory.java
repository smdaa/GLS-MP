 ...
 */
package fr.enseeiht.gls.pDL1.util;
 ...
 * <!-- end-user-doc -->
 * @see fr.enseeiht.gls.pDL1.PDL1Package
 * @generated
 */
public class PDL1AdapterFactory extends AdapterFactoryImpl
{
  ...
  protected PDL1Switch<Adapter> modelSwitch =
    ...
    {
      @Override
      public Adapter caseProcess(fr.enseeiht.gls.pDL1.Process object)
      {
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.enseeiht.gls.pDL1.Process <em>Process</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.enseeiht.gls.pDL1.ProcessElement <em>Process Element</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.enseeiht.gls.pDL1.WorkDefinition <em>Work Definition</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.enseeiht.gls.pDL1.WorkSequence <em>Work Sequence</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.enseeiht.gls.pDL1.Guidance <em>Guidance</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
