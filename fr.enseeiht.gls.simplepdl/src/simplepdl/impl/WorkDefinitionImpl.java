 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getNecessary_ressources <em>Necessary ressources</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	/**
	 * The cached value of the '{@link #getNecessary_ressources() <em>Necessary ressources</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getNecessary_ressources()
	 * @generated
	 * @ordered
	 */
	protected EList<Ressource_Usage> necessary_ressources;
	 ...
	 * @generated
	 */
	public EList<Ressource_Usage> getNecessary_ressources() {
		if (necessary_ressources == null) {
			necessary_ressources = new EObjectContainmentEList<Ressource_Usage>(Ressource_Usage.class, this, SimplepdlPackage.WORK_DEFINITION__NECESSARY_RESSOURCES);
		}
		return necessary_ressources;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NECESSARY_RESSOURCES:
				return ((InternalEList<?>)getNecessary_ressources()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NAME:
				return getName();
			case SimplepdlPackage.WORK_DEFINITION__NECESSARY_RESSOURCES:
				return getNecessary_ressources();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NAME:
				...
				return;
			case SimplepdlPackage.WORK_DEFINITION__NECESSARY_RESSOURCES:
				getNecessary_ressources().clear();
				getNecessary_ressources().addAll((Collection<? extends Ressource_Usage>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NECESSARY_RESSOURCES:
				return necessary_ressources != null && !necessary_ressources.isEmpty();
		}
