...
public class NodeImpl extends PetriNetElementImpl implements Node {
	...
	public EList<Arc> getIn() {
		if (in == null) {
			in = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, PetrinetPackage.NODE__IN, PetrinetPackage.ARC__TO);
		}
		return in;
	}
	...
	public EList<Arc> getOut() {
		if (out == null) {
			out = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, PetrinetPackage.NODE__OUT, PetrinetPackage.ARC__FROM);
		}
		return out;
	}
