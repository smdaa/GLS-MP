...
public class PetrinetFactoryImpl extends EFactoryImpl implements PetrinetFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case PetrinetPackage.PETRI_NET_ELEMENT: return createPetriNetElement();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case PetrinetPackage.TYPE_OF_ARC:
				return createTypeOfArcFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case PetrinetPackage.TYPE_OF_ARC:
				return convertTypeOfArcToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public TypeOfArc createTypeOfArcFromString(EDataType eDataType, String initialValue) {
		TypeOfArc result = TypeOfArc.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertTypeOfArcToString(EDataType eDataType, Object instanceValue) {
