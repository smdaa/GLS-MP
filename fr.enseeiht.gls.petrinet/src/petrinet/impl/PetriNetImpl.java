 ...
 * </p>
 * <ul>
 *   <li>{@link petrinet.impl.PetriNetImpl#getElement <em>Element</em>}</li>
...
public class PetriNetImpl extends MinimalEObjectImpl.Container implements PetriNet {
	 ...
	 * @ordered
	 */
	protected EList<PetriNetElement> element;
	 ...
	 * @generated
	 */
	public EList<PetriNetElement> getElement() {
		if (element == null) {
			element = new EObjectContainmentEList<PetriNetElement>(PetriNetElement.class, this, PetrinetPackage.PETRI_NET__ELEMENT);
		}
		return element;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetrinetPackage.PETRI_NET__ELEMENT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case PetrinetPackage.PETRI_NET__ELEMENT:
				getElement().clear();
				getElement().addAll((Collection<? extends PetriNetElement>)newValue);
				return;
			case PetrinetPackage.PETRI_NET__NAME:
