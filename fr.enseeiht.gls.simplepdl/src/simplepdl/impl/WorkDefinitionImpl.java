...
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	 ...
	 * @ordered
	 */
	protected EList<Ressource> necessary_ressources;
	 ...
	 * @generated
	 */
	public EList<Ressource> getNecessary_ressources() {
		if (necessary_ressources == null) {
			necessary_ressources = new EObjectContainmentEList<Ressource>(Ressource.class, this, SimplepdlPackage.WORK_DEFINITION__NECESSARY_RESSOURCES);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NECESSARY_RESSOURCES:
				...
				getNecessary_ressources().addAll((Collection<? extends Ressource>)newValue);
				return;
		}
